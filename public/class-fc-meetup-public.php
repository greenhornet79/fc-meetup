 ...
 *
 * @package    FC_Meetup
 * @subpackage FC_Meetup/admin
 * @author     Your Name <email@example.com>
 */
class FC_Meetup_Public {
	...
	public function enqueue_styles() {
		 ...
		 * defined in FC_Meetup_Public_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The FC_Meetup_Public_Loader will then create the relationship
